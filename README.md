...
# 🚀 快速使用
## 一、下载与解压
首先获取软件安装包：点击链接 [MouseEngine-Beta1.2](https://github.com/quanmouren/MouseEngine/releases/download/Beta1.2/MouseEngine-Beta1.2-windows-x64.zip) 下载软件压缩包。下载完成后，将压缩包解压到你希望存放的位置。
