(function () {
    ...
    const dictionaries = {
        "zh-CN": {
            ...
            "exportGroup": "导出该组",
            "exportGroupSuccess": "已导出该组",
            "exportGroupFailed": "导出该组失败",
            "importGroup": "导入组",
            "importGroupSuccess": "已导入组",
            "newGroup": "新建组",
            ...
            "backupSection": "导入导出备份",
            "backupExport": "导出备份",
            "backupImport": "恢复备份",
            "backupRestoreTitle": "恢复备份",
            "backupRestoreWarning": "这将覆盖现有的所有配置文件。在导入前，请先确认当前配置已有备份版本。",
            "backupRestoreMergeHint": "合并至当前配置：不会删除原有内容，同名光标组将使用恢复的版本。",
            "backupRestoreOverwriteHint": "完全覆盖当前配置：删除除恢复文件以外的所有鼠标组和配置。",
            "backupMerge": "合并至当前配置",
            "backupOverwrite": "完全覆盖当前配置",
            "backupExportSuccess": "已导出备份",
            "backupExportFailed": "导出备份失败",
            "backupImportSuccess": "已恢复备份",
            "backupImportFailed": "恢复备份失败",
        ...
        "en": {
            ...
            "exportGroup": "Export This Group",
            "exportGroupSuccess": "Group exported",
            "exportGroupFailed": "Failed to export group",
            "importGroup": "Import Group",
            "importGroupSuccess": "Group imported",
            "newGroup": "New Group",
            ...
            "backupSection": "Import / Export Backup",
            "backupExport": "Export Backup",
            "backupImport": "Restore Backup",
            "backupRestoreTitle": "Restore Backup",
            "backupRestoreWarning": "This will overwrite all existing config files. Please make sure the current config is backed up before importing.",
            "backupRestoreMergeHint": "Merge with current config: existing content is preserved; same-named mouse groups will be replaced by the restored version.",
            "backupRestoreOverwriteHint": "Fully overwrite current config: delete all mouse groups and configs except the restored files.",
            "backupMerge": "Merge with Current",
            "backupOverwrite": "Fully Overwrite",
            "backupExportSuccess": "Backup exported",
            "backupExportFailed": "Failed to export backup",
            "backupImportSuccess": "Backup restored",
            "backupImportFailed": "Failed to restore backup",
        ...
        "ja": {
            ...
            "exportGroup": "このグループをエクスポート",
            "exportGroupSuccess": "グループをエクスポートしました",
            "exportGroupFailed": "グループのエクスポートに失敗しました",
            "importGroup": "グループをインポート",
            "importGroupSuccess": "グループをインポートしました",
            "newGroup": "新規グループ",
            ...
            "backupSection": "バックアップのインポート／エクスポート",
            "backupExport": "バックアップをエクスポート",
            "backupImport": "バックアップを復元",
            "backupRestoreTitle": "バックアップを復元",
            "backupRestoreWarning": "これにより既存のすべての設定ファイルが上書きされます。インポート前に現在の設定がバックアップされていることを確認してください。",
            "backupRestoreMergeHint": "現在の設定にマージ：既存の内容は保持され、同名のカーソルグループは復元されたバージョンで置き換えられます。",
            "backupRestoreOverwriteHint": "現在の設定を完全に上書き：復元されたファイル以外のすべてのカーソルグループと設定を削除します。",
            "backupMerge": "現在の設定にマージ",
            "backupOverwrite": "完全に上書き",
            "backupExportSuccess": "バックアップをエクスポートしました",
            "backupExportFailed": "バックアップのエクスポートに失敗しました",
            "backupImportSuccess": "バックアップを復元しました",
            "backupImportFailed": "バックアップの復元に失敗しました",
