...
def tr(key):
    ...
    translations = {
        "zh-CN": {
            ...
            "tray_title_specified_mouse_group_paused": "光标引擎 (被指定光标组暂停)",
            "configure_mouse_groups": "配置鼠标组",
            "bind_mouse_groups": "绑定鼠标组",
            "settings": "设置",
            "openMouseEngine": "MouseEngine",
            "pause": "暂停",
            "resume": "解除暂停",
            "specified_mouse_group_paused": "被指定光标组暂停",
            "exit": "退出",
        ...
        "en": {
            ...
            "tray_title_specified_mouse_group_paused": "MouseEngine (Specified cursor group paused)",
            ...
            "pause": "Pause",
            "resume": "Resume",
            "specified_mouse_group_paused": "Specified cursor group paused",
            "exit": "Exit",
        ...
        "ja": {
            ...
            "tray_title_specified_mouse_group_paused": "MouseEngine (指定カーソルグループで一時停止中)",
            ...
            "pause": "一時停止",
            "resume": "再開",
            "specified_mouse_group_paused": "指定カーソルグループで一時停止中",
            "exit": "終了",
